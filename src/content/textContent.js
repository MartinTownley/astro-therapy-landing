export const heroText0 = {
  heading: 'Psychotherapy and Counselling',
  subheading: 'Waltham Forest, London • Online',
  button: 'Get in touch',
}

export const heroText = {
  heading: 'Counselling and Psychotherapy in Walthamstow',
